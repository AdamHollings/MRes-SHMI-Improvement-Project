...
# MAGIC %md
# MAGIC # Year Split Calibrated LogReg saga (Ridge regression) model Raw unbalanced data Charlson Groups No Ethnicity v1
...
model_name = "Calib_LogisticRegression_sag"
