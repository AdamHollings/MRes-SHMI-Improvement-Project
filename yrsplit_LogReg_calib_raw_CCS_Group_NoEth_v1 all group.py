...
# MAGIC %md
# MAGIC # Calibrated Logisitc Regression Ridge Sag Raw unbalanced data CCS Groups No Ethnicity v1
# MAGIC This notebook is to test logisitc regression on the data, using charlson groups and without Ethnicity
...
model_name = "Calib_LogisticRegression_sag" #ridge regression
