...
# MAGIC %md
# MAGIC # Calibrated XGBoost default model Raw unbalanced data CCS Groups No Ethnicity v1
...
model_name = "Calib_XGBoost_default"
...
too_big_groups = [18, 33, 39, 52, 59, 73, 82, 90, 98, 100, 106, 111, 113, 114, 138, 140, 141] # too big to be processe
